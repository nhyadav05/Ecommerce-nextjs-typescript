...
export const selectWishlistCurrentPage = (state: RootState) => state.products.currentPage;
export const selectWishlistTotalPages = (state: RootState) => state.products.totalPages;
