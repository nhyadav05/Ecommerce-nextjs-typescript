...
//                 ? 'text-gray-900 shadow-sm hover:bg-gray-50 focus:outline-none'
//                 : 'text-gray-200 cursor-not-allowed bg-gray-50'
//             } ${selectedSize === size ? 'border-blue-500' : ''}`}
//             onClick={() => availableSizes.includes(size) && handleSizeChange(size)}
//           >
...
//               <span
//                 aria-hidden="true"
//                 className="absolute  pointer-events-none -inset-px rounded-md border-2 border-gray-200"
//               >
//                 <svg
//                   className="absolute  h-full w-full stroke-2 text-gray-200"
//                   viewBox="0 0 100 100"
...
const ProductDetails: React.FC = ({ params }: any) => {
  ...
  useEffect(() => {
    // Simulating API call using axios (replace with your actual API call)
    axios
      ...
      .then((response) => {
        ...
        const formattedProduct: Product = {
          ...
          description: "Description placeholder", // Replace with actual description
          price: apiProduct.price,
          discountPrice: 0, // Replace with actual discount price if applicable
          offer: "", // Replace with actual offer if applicable
          ratings: 0, // Replace with actual ratings
          reviews: 0, // Replace with actual number of reviews
        };
